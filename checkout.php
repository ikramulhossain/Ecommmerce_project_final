   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" placeholder="Mobile Number" class="box" min="0" max="99999999999" onkeypress="if(this.value.length == 10) return false;" required>
         </div>
         <div class="inputBox">
            <span>Email :</span>
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="Full Address" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" placeholder="Savar" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
